...
B. Change the device being viewed
	...
	NOTE: If the device is not available in device list when we open selected dashboard will appear below
<img src="media/In-Band Manageability User Guide - ThingsBoard/media/image66.png" style="width:5.525in;height:3.0in" />	

	NOTE: To view the created device in device list, new device should mapped with the existing device profile json file while creating new device.
