...
**'security' - Security**           |It will provide the information of | 1.whether DM verity is enabled or not |2.whether Measured Boot is enabled or not |3.whether HDDL plug-in card is provisioned or not |4.whether using Secured Xlink or not
