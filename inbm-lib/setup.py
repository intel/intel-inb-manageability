...
setup(
    ...
    install_requires=['paho-mqtt==1.6.0', 'types-paho-mqtt==1.6.0.7', 'dmidecode==0.9.0', 'xmlschema==1.5.3', 'defusedxml==0.7.1', 'future==0.18.3', 'url-normalize==1.4.3', 'snoop==0.4.3'],
    test_suite='pytest',
