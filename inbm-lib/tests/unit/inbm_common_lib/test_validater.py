...
class TestValidater(TestCase):
    ...
    def test_check_validate_guid_fail(self):
        with self.assertRaisesRegex(argparse.ArgumentTypeError,"GUID should be 36 characters displayed in five groups separated by a dash in the format XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX , Hexdigits are allowed"):
    ...
    def test_check_validate_guid_position(self):
        with self.assertRaisesRegex(argparse.ArgumentTypeError,"GUID should be 36 characters displayed in five groups separated by a dash in the format XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX"):
            validate_guid('4131-ac32-4687cb4abd27-6c8e136f-d3e6')
    def test_position_check_validate_guid(self):
        with self.assertRaisesRegex(argparse.ArgumentTypeError,"GUID should be 36 characters displayed in five groups separated by a dash in the format XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX"):
            validate_guid('ac32-4687cb4abd27-6c8e136f-d3e6-4131')
    def test_check_validate_guid_position_format(self):
        with self.assertRaisesRegex(argparse.ArgumentTypeError,"GUID should be 36 characters displayed in five groups separated by a dash in the format XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX"):
