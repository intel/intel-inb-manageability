...
class TestMQTT(TestCase):
    ...
    def test_client_publish(self, m_publish, m_connect) -> None:
        mqtt = MQTT('id', 'broker', 1, 1, tls=False)
    ...
    def test_client_subscribe(self, m_subscribe, m_connect) -> None:
        mqtt = MQTT('id', 'broker', 1, 1, tls=False)
