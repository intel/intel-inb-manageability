...
class TestTrtl(TestCase):
    ...
    def test_get_image_by_container_id(self):
        return_code, runner = self.__setup_trtl_test()
        out, err, result = Trtl(
    ...
    def test_trtl_image_pull_public(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_image_pull_private(self, mock_send_password):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_up_with_file(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_start_with_option(self):
        return_code, runner = self.__setup_trtl_test()
        out, err, result = Trtl(
    ...
    def test_trtl_image_remove_by_id(self):
        ...
        out, err, result = Trtl(
            ...
            "abc123", True)
        self.__check_trtl_output("/usr/bin/trtl -type=docker "
                                 "-cmd=imageRemoveByID -id -in=abc123 -f=True",
                                 runner.last_cmd(), return_code, result)
    ...
    def test_trtl_exec_with_config_params(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_get_latest_tag(self):
        return_code, runner = self.__setup_trtl_test()
        out, err = Trtl(
    ...
    def test_trtl_remove_old_images(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_returns_on_compose_remove_old_image(self):
        return_code, runner = self.__setup_trtl_test()
        err = Trtl(runner, "compose").remove_old_images("abc123")
        self.assertEqual(None, err)

    def test_trtl_commit(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_delete_snapshot(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_sota_rollback(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_docker_bench_security(self):
        return_code, runner = self.__setup_trtl_test()
    ...
    def test_trtl_image_remove_all(self):
        return_code, runner = self.__setup_trtl_test()
        out, err, result = Trtl(
    ...
    def test_trtl_compose_pull_with_file(self):
        return_code, runner = self.__setup_trtl_test()
