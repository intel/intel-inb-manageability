...
from ..constants import COMMAND_SUCCESS, COMMAND_FAIL, MAX_TIME_LIMIT, INBM_CONFIG_CHANNEL
...
class GetConfigCommand(ConfigCommand):
    ...
    def trigger_manifest(self, args: Any, topic: str) -> None:
        ...
        if args.targettype is None:
            CHANNEL = INBM_CONFIG_CHANNEL
        else:
            CHANNEL = CONFIG_CHANNEL + CONFIG_GET
...
class SetConfigCommand(ConfigCommand):
    ...
    def trigger_manifest(self, args: Any, topic: str) -> None:
        ...
        if args.targettype is None:
            ...
            CHANNEL = CONFIG_CHANNEL + CONFIG_SET
        super().trigger_manifest(args, CHANNEL)
