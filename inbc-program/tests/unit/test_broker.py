...
class TestINBC(TestCase):
    ...
    def test_on_event_sota_failure(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_event(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_aota_success(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('aota', self._aota_args, False)
    ...
    @patch('inbc.command.ota_command.AotaCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_aota_failed(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.ota_command.FotaCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('fota', self._fota_args, False)
        b._on_event('manageability/event', 'Overall FOTA status : SUCCESS', 1)
    ...
    @patch('inbc.command.ota_command.FotaCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_fota_success(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('fota', self._fota_args, False)
        b._on_response('manageability/response', SUCCESSFUL_INSTALL, 1)
        mock_terminate.assert_called_once()
    ...
    @patch('inbc.command.ota_command.FotaCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_fota_failed(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('fota', self._fota_args, False)
        b._on_response('manageability/response', FAILED_TO_INSTALL, 1)
        mock_terminate.assert_called_once()
    ...
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_pota_failed(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.ota_command.SotaCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_sota_failed(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('sota', self._sota_args, False)
    ...
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_get_inbm_success(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.config_command.GetConfigCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_get_inbm_failed(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('get', self._get_inbm_args, False)
    ...
    @patch('inbc.command.config_command.GetConfigCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_set_inbm_failed(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('set', self._set_inbm_args, False)
        b._on_response('manageability/response', 'Configuration command: FAILED', 1)
        mock_terminate.assert_called_once()
    ...
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_load_success(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.config_command.LoadConfigCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_load_failed(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('load', self._load_args, False)
        b._on_response('manageability/response', 'Configuration command: FAILED', 1)
        mock_terminate.assert_called_once()
    ...
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_restart_success(self, mock_terminate, mock_trigger, mock_mqtt):
    ...
    @patch('inbc.command.command.RestartCommand.trigger_manifest')
    @patch('inbc.command.command.Command.terminate_operation')
    def test_on_message_response_restart_failed(self, mock_terminate, mock_trigger, mock_mqtt):
        b = Broker('restart', self._restart_args, False)
    ...
    @patch('inbc.broker.MQTT')
    @patch('inbc.command.ota_command.FotaCommand.trigger_manifest')
    def test_on_message_response(self, mock_trigger, mock_mqtt, mock_search):
        b = Broker('fota', self._fota_args, False)
    ...
    @patch('inbc.broker.MQTT')
    @patch('inbc.command.ota_command.FotaCommand.trigger_manifest')
    def test_on_stop_broker(self, mock_trigger, mock_mqtt, mock_timer):
        b = Broker('fota', self._fota_args, False)
        b.stop_broker()
