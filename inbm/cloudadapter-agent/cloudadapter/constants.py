...
from inbm_common_lib.constants import TELEMETRY_CHANNEL, NODE_UPDATE_CHANNEL, \
     RESPONSE_CHANNEL, EVENT_CHANNEL
...
class TC_TOPIC:
    ...
    NODE_UPDATE = tuple([NODE_UPDATE_CHANNEL + "+"]) # Used for Node updates from dispatcher that are to be sent to UDM
