...
* To build statically linked go libraries (dynamically linked to e.g. pthread, libc): `CGO_ENABLED=1 go build -o trtl`
* To build fully statically linked (takes longer): `CGO_ENABLED=0 go build -o trtl`
