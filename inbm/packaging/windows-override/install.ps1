...
Download-FileIfNotExist -URL "https://slproweb.com/download/Win64OpenSSL_Light-3_1_1.msi" -DestinationPath "C:\inb-files"
...
C:\inb-files\Win64OpenSSL_Light-3_1_1.msi /qn
