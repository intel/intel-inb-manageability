...
class TestCachePolicy(TestCase):
    ...
    def test_trim_collection_five_elements_to_three_elements(self) -> None:
        self.assertEqual(trim_cache([1, 2, 3, 4, 5], 3), [3, 4, 5])

    def test_trim_collection_zero_elements_to_three_elements(self) -> None:
        self.assertEqual(trim_cache([], 3), [])

    def test_trim_collection_two_elements_to_two_elements(self) -> None:
        self.assertEqual(trim_cache([2, 3], 2), [2, 3])

    def test_trim_collection_four_element_to_one_element(self) -> None:
