...
class TestPMSNotification(TestCase):
    ...
    def test_import_pmslibrary_success(self) -> None:
        sys.path.insert(0, os.path.dirname(__file__))
        self.pmsn.import_pms_library()

    def test_import_pmslibrary_fail(self) -> None:
    ...
    def test_telemetry_with_pms_notification(self, mock_connect, mock_type, mock_telemetry) -> None:
        sys.path.insert(0, os.path.dirname(__file__))
