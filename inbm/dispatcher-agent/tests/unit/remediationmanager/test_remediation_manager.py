...
class TestRemediationManager(TestCase):
    ...
    def test_on_stop_container_success(self, mock_remove_container):
        try:
            RemediationManager(self.mock_disp_callbacks_obj, self.mock_disp_broker_obj)._on_stop_container(
    ...
    def test_on_remove_image_success(self, mock_remove_images):
        try:
            RemediationManager(self.mock_disp_callbacks_obj, self.mock_disp_broker_obj)._on_remove_image(
    ...
    def test_run(self):
        try:
            RemediationManager(self.mock_disp_callbacks_obj, self.mock_disp_broker_obj).run()
        except Exception:
    ...
    def test_return_container_no_errors(self, mock_remove_container, mock_stop_all, mock_call_telemetry, mock_image, mock_remove, mock_list):
        try:
            ...
            rm = RemediationManager(self.mock_disp_callbacks_obj, self.mock_disp_broker_obj)
    ...
    def test_telemetry_call_when_stop_errors(self, mock_remove_container, mock_stop_by_id, mock_call_telemetry,
        ...
        mock_remove_container.return_value = None
        RemediationManager(self.mock_disp_callbacks_obj, self.mock_disp_broker_obj)._remove_container(
    ...
    def test_telemetry_call_when_remove_image_errors(self, mock_remove_image, mock_call_telemetry):
        ...
        r = RemediationManager(self.mock_disp_callbacks_obj, self.mock_disp_broker_obj)
