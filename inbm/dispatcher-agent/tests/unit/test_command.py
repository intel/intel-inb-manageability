...
class TestCommand(TestCase):
    ...
    def test_command_name_set(self) -> None:
        self.assertEqual(self.obj.command, 'Test_Command')

    def test_id_set(self) -> None:
        self.assertEqual(self.obj._id, '12345')

    def test_request_topic_set(self) -> None:
        self.assertEqual(self.obj.create_request_topic(),
                         'diagnostic/command/Test_Command')

    def test_response_topic_set(self) -> None:
