...
class FOTA:
    ...
    def install(self) -> Result:
        ...
        try:
            ...
            print(guid, tool_options, self._pkg_filename)
            #logger.debug("value of guid",guid,"value of tool_options",tool_options,"value of pkg_filename",self._pkg_filename,"value of signature",self.__signature,"value of hash_algorithm",self._hash_algorithm,"value of bios_vendor",bios_vendor,"value of platform_product",platform_product)
