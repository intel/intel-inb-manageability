...
class Dispatcher(WindowsService):
    ...
    def do_install(self, xml: str, schema_location: Optional[str] = None) -> int:
        ...
        try:  # TODO: Split into multiple try/except blocks
            ...
            logger.debug("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii")
            ...
            if type_of_manifest == 'cmd':
                ...
                if target_type is TargetType.none.name and ota_type == OtaType.POTA.name.lower():
                    ...
                    logger.debug("vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv")
                    result = self._do_ota_update(
                ...
                logger.debug("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa  elif part")
                target_type = parsed_head.find_element('config/targetType')
                logger.debug('tttttttttttttttttttttttttttttttttttttttttt>elif type_of_manifest == config:')
                if target_type is None:
                    logger.debug('hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh>if target_type is None:')
                    target_type = TargetType.none.name
                ...
                if target_type is TargetType.none.name:
                    ...
                    logger.debug("rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr>else:")
            ...
            logger.debug("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
    ...
    def invoke_workload_orchestration_check(self, online_mode: bool, type_of_manifest: Optional[str] = None, parsed_head: Optional[XmlHandler] = None) -> None:
        ...
        """
        logger.debug("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
