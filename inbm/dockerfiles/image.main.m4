...
FROM registry.hub.docker.com/library/golang:1.16.2-buster as trtl-build
WORKDIR /
ENV GOPATH /build/go
...
FROM registry.hub.docker.com/library/golang:1.16.2-buster as inb-provision-certs
...
FROM registry.hub.docker.com/library/golang:1.16.2-buster as inb-provision-cloud
...
FROM registry.hub.docker.com/library/golang:1.16.2-buster as inb-provision-ota-cert
