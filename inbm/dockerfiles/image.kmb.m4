...
FROM registry.hub.docker.com/arm64v8/golang:1.16.3-buster as build-inb-provision-certs
...
FROM registry.hub.docker.com/arm64v8/golang:1.16.3-buster as build-inb-provision-cloud
...
FROM registry.hub.docker.com/arm64v8/golang:1.16.3-buster as build-inb-provision-ota-cert
...
FROM registry.hub.docker.com/arm64v8/golang:1.16.3-buster as trtl-build-arm64
WORKDIR /
ENV GOPATH /build/go
