...
FROM registry.hub.docker.com/library/golang:1.16.2-buster as inb-provision-certs-windows
...
FROM registry.hub.docker.com/library/golang:1.16.2-buster as inb-provision-cloud-windows
