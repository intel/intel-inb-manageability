...
FROM registry.hub.docker.com/library/golang:1.17.6-buster as inb-provision-certs-windows
...
FROM registry.hub.docker.com/library/golang:1.17.6-buster as inb-provision-cloud-windows
