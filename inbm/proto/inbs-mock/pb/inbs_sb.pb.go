...
var file_inbs_v1_inbs_sb_proto_goTypes = []any{
...
func file_inbs_v1_inbs_sb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_inbs_v1_inbs_sb_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_inbs_v1_inbs_sb_proto_msgTypes[2].OneofWrappers = []any{
		(*INBMCommand_UpdateScheduledOperations)(nil),
		(*INBMCommand_Ping)(nil),
	}
	file_inbs_v1_inbs_sb_proto_msgTypes[5].OneofWrappers = []any{
