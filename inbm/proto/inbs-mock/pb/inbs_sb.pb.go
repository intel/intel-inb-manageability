...
type SendNodeUpdateRequest_JobUpdate struct {
	JobUpdate *Job `protobuf:"bytes,2,opt,name=job_update,json=jobUpdate,proto3,oneof"` // node_id will be filled in by INBS; schedule_id, executed_by, desired_start_time, create_time will be ignored
}

func (*SendNodeUpdateRequest_JobUpdate) isSendNodeUpdateRequest_Update() {}

type SendStaticTelemetryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RequestId       string           `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	StaticTelemetry *StaticTelemetry `protobuf:"bytes,2,opt,name=static_telemetry,json=staticTelemetry,proto3" json:"static_telemetry,omitempty"`
}

func (x *SendStaticTelemetryRequest) Reset() {
	*x = SendStaticTelemetryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SendStaticTelemetryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendStaticTelemetryRequest) ProtoMessage() {}

func (x *SendStaticTelemetryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_inbs_v1_inbs_sb_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendStaticTelemetryRequest.ProtoReflect.Descriptor instead.
func (*SendStaticTelemetryRequest) Descriptor() ([]byte, []int) {
	return file_inbs_v1_inbs_sb_proto_rawDescGZIP(), []int{6}
}

func (x *SendStaticTelemetryRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *SendStaticTelemetryRequest) GetStaticTelemetry() *StaticTelemetry {
	if x != nil {
...
var file_inbs_v1_inbs_sb_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_inbs_v1_inbs_sb_proto_goTypes = []interface{}{
	...
	(*SendStaticTelemetryRequest)(nil), // 6: inbs.v1.SendStaticTelemetryRequest
...
var file_inbs_v1_inbs_sb_proto_depIdxs = []int32{
	...
	9,  // 4: inbs.v1.UpdateScheduledOperations.scheduled_operations:type_name -> common.v1.ScheduledOperation
	10, // 5: inbs.v1.SendNodeUpdateRequest.job_update:type_name -> common.v1.Job
	11, // 6: inbs.v1.SendStaticTelemetryRequest.static_telemetry:type_name -> common.v1.StaticTelemetry
	8,  // 7: inbs.v1.SendNodeUpdateResponse.error:type_name -> common.v1.Error
	1,  // 8: inbs.v1.INBSSBService.HandleINBMCommand:input_type -> inbs.v1.HandleINBMCommandResponse
	5,  // 9: inbs.v1.INBSSBService.SendNodeUpdate:input_type -> inbs.v1.SendNodeUpdateRequest
	6,  // 10: inbs.v1.INBSSBService.SendStaticTelemetry:input_type -> inbs.v1.SendStaticTelemetryRequest
	...
	7,  // 13: inbs.v1.INBSSBService.SendStaticTelemetry:output_type -> inbs.v1.SendNodeUpdateResponse
...
func file_inbs_v1_inbs_sb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_inbs_v1_inbs_sb_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SendStaticTelemetryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
